...
VALUES ('Michael Jackson', 'Thriller', 1982, 47.3, 'Pop, Rock & R&B'),
      ('The Eagles', 'Their Greatest Hits (1971-1975)', 1976, 41.2, 'Country rock, soft rock'),
      ...
      ('Meat Loaf',	'Bat Out of Hell',	1977, 21.5, 'Hard Rock, Glam Rock'),
      ('Bee Gees',	'Saturday Night Fever',	1977, 21.6, 'Disco'),
      ('Fleetwood Mac',	'Rumours',	1977, 27.9, 'Soft Rock'),
      ('Shania Twain',	'Come On Over',	1997, 29.6, '21.6'),
