...
FROM employees
WHERE emp_no IN ( -- larger query that looks for names and DOBs for department managers
  SELECT emp_no
  FROM dept_manager -- returns all the department managers first and last names.
)
LIMIT 10;
